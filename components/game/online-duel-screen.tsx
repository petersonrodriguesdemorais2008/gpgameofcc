...
= 2
 ...
 f !== null)
    ...
    } else if (ug.id === "vatnavordr-messiham-ur" || ug.name?.toLowerCase().includes("vatnavordr") || ug.ability?.toLowerCase().includes("congelamento de vatnavordr")) {
...
Iniciando duelo...</p
      ...
      onTouchEnd={() =
 {
      ...
      {freezeAnimationCard && (
        <FreezeCardAnimation cardName={freezeAnimationCard} onComplete={() =
